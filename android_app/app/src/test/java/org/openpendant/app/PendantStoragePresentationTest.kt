...
class PendantStoragePresentationTest {
    @Test fun fullProfileShowsActualAllocatedSpaceAndConservesBytes() {
        ...
        assertNotNull(PendantStoragePresentation.from(full.copy(firmware="0.4.61")))
        assertEquals(p,PendantStoragePresentation.from(full.copy(firmware="0.4.62")))
        assertNull(PendantStoragePresentation.from(full.copy(firmware="0.4.62",recorder=full.recorder!!.copy(slotsTotal=5119))))
        assertNotNull(PendantStoragePresentation.from(full.copy(firmware="0.4.63")))
        assertNull(PendantStoragePresentation.from(full.copy(firmware="0.4.64")))
